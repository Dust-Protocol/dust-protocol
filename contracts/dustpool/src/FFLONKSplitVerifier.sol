...
contract FflonkSplitVerifier {
    ...
    uint256 constant C0x  = 21171065628665521893557425982638955279208141433636339292822642243559911125191;
    uint256 constant C0y  = 14280259575751023007196042458901078540047175494462168115573164843629806377096;
    ...
    uint16 constant lastMem = 2368;
     

    function verifyProof(bytes32[24] calldata proof, uint256[15] calldata pubSignals) public view returns (bool) {
        assembly {
            ...
            function computeChallenges(pMem, pPublic) {
                ...
                mstore(add(pMem, 2368 ), C0x)
                mstore(add(pMem, 2400 ), C0y)

                mstore(add(pMem, 2432), calldataload(pPublic))
                
                mstore(add(pMem, 2464 ), calldataload(add(pPublic, 32)))
                
                mstore(add(pMem, 2496 ), calldataload(add(pPublic, 64)))
                
                mstore(add(pMem, 2528 ), calldataload(add(pPublic, 96)))
                
                mstore(add(pMem, 2560 ), calldataload(add(pPublic, 128)))
                
                mstore(add(pMem, 2592 ), calldataload(add(pPublic, 160)))
                
                mstore(add(pMem, 2624 ), calldataload(add(pPublic, 192)))
                
                mstore(add(pMem, 2656 ), calldataload(add(pPublic, 224)))
                
                mstore(add(pMem, 2688 ), calldataload(add(pPublic, 256)))
                
                mstore(add(pMem, 2720 ), calldataload(add(pPublic, 288)))
                
                mstore(add(pMem, 2752 ), calldataload(add(pPublic, 320)))
                
                mstore(add(pMem, 2784 ), calldataload(add(pPublic, 352)))
                
                mstore(add(pMem, 2816 ), calldataload(add(pPublic, 384)))
                
                mstore(add(pMem, 2848 ), calldataload(add(pPublic, 416)))
                
                mstore(add(pMem, 2880 ), calldataload(add(pPublic, 448)))
                
                

                mstore(add(pMem, 2912 ),  calldataload(pC1))
                mstore(add(pMem, 2944 ),  calldataload(add(pC1, 32)))

                mstore(add(pMem, pBeta),  mod(keccak256(add(pMem, lastMem), 608), q))
                mstore(add(pMem, pGamma), mod(keccak256(add(pMem, pBeta), 32), q))

                // Get xiSeed & xiSeed2
                mstore(add(pMem, lastMem), mload(add(pMem, pGamma)))
                mstore(add(pMem, 2400), calldataload(pC2))
                mstore(add(pMem, 2432), calldataload(add(pC2, 32)))
                ...
                calldatacopy(add(pMem, 2400), pEval_ql, 480)
                mstore(add(pMem, pAlpha), mod(keccak256(add(pMem, lastMem), 512), q))

                // Compute challenge.y
                mstore(add(pMem, lastMem), mload(add(pMem, pAlpha)))
                mstore(add(pMem, 2400 ),  calldataload(pW1))
                mstore(add(pMem, 2432 ),  calldataload(add(pW1, 32)))
