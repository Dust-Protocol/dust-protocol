        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.alchemy.com https://*.infura.io https://*.r2.dev https://*.privy.io wss://*.alchemy.com wss://*.infura.io https://rpc.sepolia.org https://sepolia.optimism.io https://sepolia.base.org https://sepolia-rollup.arbitrum.io https://rpc.thanos-sepolia.tokamak.network https://testnet.evm.nodes.onflow.org https://api.gelato.digital https://cdn.unicorn.studio https://assets.unicorn.studio https://gateway.pinata.cloud https://gateway.lighthouse.storage https://*.ipfs.w3s.link https://*.ipfs.storacha.link https://node.lighthouse.storage",
