...
import { ConfidentialPoolCard } from "@/components/dustpool/ConfidentialPoolCard";
...
export default function PoolsPageClient() {
  ...
  const hasConfidentialPool = !!chainConfig.contracts.confidentialDustPool;
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-center">
              <div className="w-full max-w-[480px]">
                <ConfidentialPoolCard chainId={activeChainId} />
              </div>
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col gap-4">
          <div className="p-3 rounded-sm bg-[rgba(0,255,65,0.04)] border border-[rgba(0,255,65,0.12)]">
            <p className="text-[12px] text-[rgba(255,255,255,0.4)] leading-relaxed font-mono">
              Deposit any amount of {nativeSymbol} or USDC into a single global pool. Transfer privately between users with hidden amounts,
